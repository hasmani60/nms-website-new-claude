      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            ...
            />
            <span className={`text-base sm:text-xl font-semibold tracking-tight transition-colors duration-300 ${
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 lg:px-5 py-2.5 rounded-full text-base lg:text-lg font-medium transition-all duration-300 ${
                    isActive
          ...
          <a 
            ...
            className={`hidden md:flex items-center gap-2 px-4 lg:px-6 py-2.5 rounded-full text-base lg:text-lg font-medium transform hover:-translate-y-0.5 transition-all duration-300 ${
              useWhiteText
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-xl border-t border-emerald-100">
            <nav className="flex flex-col p-4 space-y-2">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-3 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-lg font-medium text-center"
              >
                Try Demo
              </a>
            </nav>
...
const Footer = () => {
  ...
  // Helper function to map label to page ID
  const getPageId = (label) => {
    const mapping = {
      'Home': 'home',
      'About Us': 'about',
      'Products': 'products',
    ...
    return mapping[label] || label.toLowerCase().replace(' ', '');
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-12 sm:mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Home', 'About Us', 'Products', 'Contact'].map((item) => (
                <li key={item}>
                  <button 
                    onClick={() => setCurrentPage(getPageId(item))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="mailto:naturemarksystems@gmail.com" className="text-emerald-200/70 hover:text-white transition-colors text-base break-all">
        ...
        <div className="pt-8 border-t border-emerald-800/50 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-emerald-200/50 text-sm sm:text-base text-center md:text-left">
            © 2025 NatureMark Systems. All rights reserved.
          </p>
          <div className="flex items-center gap-4 sm:gap-6">
            <button onClick={() => setCurrentPage('privacy')} className="text-emerald-200/50 hover:text-white text-sm sm:text-base transition-colors">Privacy Policy</button>
            <button onClick={() => setCurrentPage('terms')} className="text-emerald-200/50 hover:text-white text-sm sm:text-base transition-colors">Terms of Service</button>
          </div>
        </div>
      </div>
    </footer>
  ...
  return (
    <section className="min-h-screen relative flex items-center overflow-hidden bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 right-1/4 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] bg-emerald-500/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 left-1/4 w-[250px] sm:w-[500px] h-[250px] sm:h-[500px] bg-teal-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 pb-16 sm:pb-20 relative">
        <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-center">
          {/* Content */}
          <div className="text-white text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full mb-6 sm:mb-8 backdrop-blur-sm">
              <div className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse" />
              <span className="text-emerald-100 text-base sm:text-lg font-medium">Green Tech Solutions</span>
            </div>
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-emerald-100/80 mb-8 sm:mb-10 max-w-lg leading-relaxed mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center lg:justify-start">
              <button 
                ...
                className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-emerald-900 rounded-full font-semibold hover:shadow-2xl hover:shadow-white/20 transform hover:-translate-y-1 transition-all duration-300 text-base sm:text-lg"
              >
                Work With Us
              </button>
              <button 
                onClick={() => setCurrentPage('products')}
                className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-white/30 text-white rounded-full font-semibold hover:bg-white/10 transition-all duration-300 text-base sm:text-lg"
              >
                Explore Products
              </button>
            </div>
          ...
          <div className="hidden lg:block relative">
            <div className="relative w-full aspect-square">
              {/* Floating Cards */}
              <div className="absolute top-10 left-10 p-4 sm:p-6 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 animate-float">
                <div className="text-3xl sm:text-5xl font-bold text-white">40%</div>
                <div className="text-emerald-200 text-sm sm:text-base">Emission Reduction</div>
              </div>
              
              <div className="absolute bottom-20 right-10 p-4 sm:p-6 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 animate-float" style={{ animationDelay: '0.5s' }}>
                <div className="text-3xl sm:text-5xl font-bold text-white">500+</div>
                <div className="text-emerald-200 text-sm sm:text-base">Trees Monitored</div>
              </div>
              
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 sm:w-64 h-48 sm:h-64 bg-gradient-to-br from-emerald-400/30 to-teal-400/30 rounded-full blur-xl" />
              
              {/* Central Logo */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-160 sm:w-160 h-160 sm:h-160 flex items-center justify-center">
                <img 
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/50">
  ...
  return (
    <section className="py-16 sm:py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-center">
          <div>
            <span className="text-emerald-600 font-medium text-sm sm:text-base uppercase tracking-wider">About Us</span>
            <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-emerald-900 mt-3 sm:mt-4 mb-4 sm:mb-6">
              NatureMark Systems
            </h2>
            <p className="text-lg sm:text-xl lg:text-2xl text-slate-600 leading-relaxed mb-6 sm:mb-8">
            ...
            >
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-emerald-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg shadow-emerald-600/30">
                <PlayIcon className="w-5 h-5 sm:w-6 sm:h-6 text-white ml-1" />
              </div>
              <div>
                <span className="text-sm sm:text-base text-slate-600">Find out how we were founded</span>
          ...
          <div className="relative">
            ...
            {/* Stats Card */}
            <div className="absolute -bottom-6 -left-4 sm:-bottom-8 sm:-left-8 p-4 sm:p-6 bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-100 rounded-xl flex items-center justify-center">
                  <CheckIcon className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600" />
                </div>
                <div>
                  <div className="text-3xl sm:text-5xl font-bold text-emerald-900">100%</div>
                  <div className="text-slate-500 text-sm sm:text-base">Compliance Rate</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <section className="py-16 sm:py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          <span className="text-emerald-600 font-medium text-sm sm:text-base uppercase tracking-wider">Our Products</span>
          <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-emerald-900 mt-3 sm:mt-4">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
          {products.map((product) => (
            ...
            >
              <div className={`h-48 sm:h-64 bg-gradient-to-br ${product.gradient} relative overflow-hidden`}>
                <img 
              ...
              <div className="p-6 sm:p-8">
                <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-emerald-900 mb-2">{product.name}</h3>
                <p className="text-slate-500 mb-3 sm:mb-4 text-sm sm:text-base">{product.tagline}</p>
                <p className="text-slate-600 mb-4 sm:mb-6 text-sm sm:text-base">{product.description}</p>
                
                <div className="flex flex-wrap gap-2 mb-4 sm:mb-6">
                  {product.features.map((feature) => (
                    <span key={feature} className="px-3 py-1 bg-emerald-50 text-emerald-700 rounded-full text-sm sm:text-base">
                      {feature}
                    </span>
                  ))}
                </div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 text-emerald-600 font-semibold group-hover:gap-4 transition-all text-sm sm:text-base"
                >
                  Explore More
...
const TestimonialsSection = () => {
  ...
  return (
    <>
      {/* Testimonials */}
      <section className="bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-900 py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12">
            {/* Left - Logo */}
            <div className="bg-white rounded-2xl p-6 sm:p-8 w-48 h-48 sm:w-64 sm:h-64 flex items-center justify-center flex-shrink-0">
              <img 
                src={client.logo} 
                alt={client.name}
                ...
                onError={(e) => { 
                  e.target.style.display = 'none';
                  e.target.parentElement.innerHTML = `<span class="text-emerald-800 font-bold text-xl sm:text-2xl text-center">${client.name}</span>`;
                }}
              />
            </div>
            ...
            <div className="flex-1">
              <div className="text-white text-6xl sm:text-8xl font-serif leading-none mb-4">"</div>
              
              <p className="text-white text-lg sm:text-xl lg:text-2xl leading-relaxed mb-4 sm:mb-6">
                {client.testimonial}
              </p>
              
              <div className="mb-6 sm:mb-8 flex flex-wrap items-center">
                <span className="text-white font-semibold text-base sm:text-lg">{client.person}</span>
                <span className="text-emerald-200 mx-2">•</span>
                <span className="text-emerald-200 text-sm sm:text-base">{client.role}, {client.name}</span>
              </div>
              
              <div className="flex gap-3">
                <button 
                  onClick={() => setActiveIndex((prev) => (prev - 1 + clientsData.length) % clientsData.length)}
                  className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white/20 flex items-center justify-center text-white hover:bg-white hover:text-emerald-900 transition-all"
                >
                ...
                <button 
                  ...
                  className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white flex items-center justify-center text-emerald-900 hover:bg-emerald-100 transition-all"
                >
                  <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 text-center mb-8 sm:mb-12">Our Clients</h3>
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-8">
            {clientsData.map((c, index) => (
              <button 
                key={c.id}
                onClick={() => setActiveIndex(index)}
                className={`h-20 w-28 sm:h-24 sm:w-36 rounded-2xl flex items-center justify-center p-3 sm:p-4 transition-all duration-300 ${
                  index === activeIndex 
              ...
              >
                <img 
                  ...
                  onError={(e) => { 
                    e.target.parentElement.innerHTML = `<span class="text-slate-500 font-medium text-xs sm:text-sm text-center">${c.name}</span>`;
                  }}
                />
              </button>
            ))}
  ...
  return (
    <section className="py-16 sm:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span className="text-emerald-600 font-medium text-sm sm:text-base uppercase tracking-wider">Accreditations</span>
        <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-emerald-900 mt-3 sm:mt-4 mb-4 sm:mb-6">
          Our Accreditations
        </h2>
        <p className="text-lg sm:text-xl lg:text-2xl text-slate-600 max-w-2xl mx-auto mb-8 sm:mb-12">
          Our accreditations reinforce our commitment to standards-aligned sustainability and rigorous methodologies.
        </p>
        
        <div className="flex flex-wrap justify-center gap-8 sm:gap-12">
          <div className="w-48 h-32 sm:w-64 sm:h-40 bg-slate-20 rounded-2xl flex items-center justify-center p-4 sm:p-6">
            <img src="/images/logo-iiswbm.svg" alt="IISWBM" className="max-w-full max-h-full object-contain" onError={(e) => { e.target.parentElement.innerHTML = '<span class="text-slate-400 text-sm sm:text-base">IISWBM</span>' }} />
          </div>
          <div className="w-48 h-32 sm:w-64 sm:h-40 bg-slate-20 rounded-2xl flex items-center justify-center p-4 sm:p-6">
            <img src="/images/logo-cii.svg" alt="CII" className="max-w-full max-h-full object-contain" onError={(e) => { e.target.parentElement.innerHTML = '<span class="text-slate-400 text-sm sm:text-base">CII</span>' }} />
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <main className="pt-16 sm:pt-20">
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-emerald-50 to-teal-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-emerald-900 mb-4 sm:mb-6">
            At NatureMark Systems
          </h1>
          <p className="text-lg sm:text-xl lg:text-2xl text-slate-600 max-w-2xl">
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-center mb-16 sm:mb-24">
            <div className="aspect-square bg-gradient-to-br from-emerald-100 to-teal-100 rounded-3xl p-8 sm:p-12">
          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-center">
            <div className="lg:order-2 aspect-square bg-gradient-to-br from-teal-100 to-emerald-100 rounded-3xl p-8 sm:p-12">
      ...
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <span className="text-emerald-600 font-medium text-sm sm:text-base uppercase tracking-wider">Our Team</span>
            <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-emerald-900 mt-3 sm:mt-4">
              Meet the Founders
            </h2>
          </div>
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                <div className={`overflow-hidden rounded-2xl transition-all duration-500 ${
                  index === activeTeamMember ? 'w-40 h-56 sm:w-56 sm:h-72' : 'w-24 h-32 sm:w-32 sm:h-44'
                }`}>
          ...
          <div className="mt-8 sm:mt-12 text-center max-w-2xl mx-auto px-4">
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-emerald-900">
              {teamMembers[activeTeamMember].name}
            </h3>
            <p className="text-emerald-600 mb-3 sm:mb-4 text-base sm:text-lg">{teamMembers[activeTeamMember].role}</p>
            <p className="text-lg sm:text-xl lg:text-2xl text-slate-600 italic">
    ...
    <main className="pt-16 sm:pt-20">
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 sm:space-y-24">
          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-center">
            ...
            <div>
              <span className="inline-block px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-sm sm:text-base mb-4">Carbon Intelligence</span>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-emerald-900 mb-3 sm:mb-4">CarbonDesk</h2>
              <p className="text-xl sm:text-2xl text-emerald-600 mb-3 sm:mb-4">Enterprise Carbon Intelligence Platform</p>
              ...
              <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                {['Complete Scope 1, 2 & 3 emissions tracking', 'AI-powered analytics and insights', 'Automated ESG reporting', 'Net Zero pathway planning'].map((item) => (
                  <li key={item} className="flex items-center gap-3">
                    <CheckIcon className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 flex-shrink-0" />
              ...
              <button
                onClick={() => setCurrentPage('sustain360')}
                className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-emerald-600 text-white rounded-full font-medium hover:bg-emerald-700 transition-colors text-sm sm:text-base"
              >
                Learn More
          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-center">
            ...
            <div className="lg:order-1">
              <span className="inline-block px-3 py-1 bg-teal-100 text-teal-700 rounded-full text-sm sm:text-base mb-4">AI-Powered Tree Monitoring</span>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-emerald-900 mb-3 sm:mb-4">ArborTag</h2>
              <p className="text-lg sm:text-xl text-teal-600 mb-3 sm:mb-4">Measure. Monitor. Sustain</p>
              <p className="text-slate-600 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
              ...
              <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                {['Smart tagging with AI vision', 'Real-time growth tracking', 'Geo-fencing & mapping', 'Carbon sequestration calculation'].map((item) => (
                  <li key={item} className="flex items-center gap-3">
                    <CheckIcon className="w-4 h-4 sm:w-5 sm:h-5 text-teal-600 flex-shrink-0" />
                    <span className="text-slate-600 text-sm sm:text-base">{item}</span>
                  </li>
                ))}
              </ul>
              <button
                onClick={() => setCurrentPage('arbortag')}
                className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-teal-600 text-white rounded-full font-medium hover:bg-teal-700 transition-colors text-sm sm:text-base"
              >
                Learn More
                <ArrowRightIcon className="w-4 h-4 sm:w-5 sm:h-5" />
              </button>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-emerald-600 to-teal-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button
            onClick={() => setCurrentPage('contact')}
            className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-emerald-700 rounded-full font-semibold hover:shadow-xl transition-shadow text-base sm:text-lg"
          >
            Get in Touch
          </button>
        </div>
...
// Sustain360 Product Detail Page - CORRECTED
  ...
  return (
    <main>
      ...
      <section className="relative min-h-[60vh] sm:min-h-[70vh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 pb-16 sm:pb-24 text-center w-full">
          <div className="w-50 h-50 sm:w-50 sm:h-50 flex items-center justify-center mx-auto mb-6 sm:mb-8">
            <img 
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-emerald-900 rounded-full font-semibold hover:shadow-xl hover:shadow-white/20 transition-all duration-300 text-base sm:text-lg"
            >
            View Demo
            </a>
          </div>
      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex-1">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12">
            {/* What We Do */}
            <section id="what-we-do" className="py-12 sm:py-24">
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-16 items-center">
                <div>
                  <span className="inline-block px-4 py-1.5 bg-emerald-100 text-emerald-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">What we do</span>
                  <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 mb-4 sm:mb-6 leading-tight">
                    Measure, monitor and manage greenhouse gas emissions
                  </h2>
                  <p className="text-lg sm:text-xl lg:text-2xl text-slate-600 leading-relaxed mb-4 sm:mb-6">
            ...
            {/* Problem */}
            <section id="problem" className="py-12 sm:py-24">
              <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
                <span className="inline-block px-4 py-1.5 bg-emerald-100 text-emerald-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">The Problem We Solve</span>
                <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 mb-4 sm:mb-6 leading-tight">
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                {sustain360Problems.map((problem, index) => (
                  <div key={index} className="p-6 sm:p-8 bg-white rounded-2xl border border-slate-200 hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-100/50 transition-all duration-300">
                    <div className="w-10 h-10 bg-emerald-100 rounded-xl flex items-center justify-center mb-4">
                      <span className="text-emerald-600 font-bold">{String(index + 1).padStart(2, '0')}</span>
                    </div>
                    <p className="text-slate-700 text-base sm:text-lg">{problem}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            {/* Solution */}
            <section id="solution" className="py-12 sm:py-24">
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-16 items-center">
                ...
                <div className="order-1 lg:order-2">
                  <span className="inline-block px-4 py-1.5 bg-emerald-100 text-emerald-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">Our Solution</span>
                  <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 mb-4 sm:mb-6 leading-tight">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-base sm:text-lg font-semibold text-slate-900">Smart Analytics That Drive Action</h3>
                    {[
            ...
            {/* Why Sustain360 */}
            <section id="why" className="py-12 sm:py-24">
              <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
                <span className="inline-block px-4 py-1.5 bg-emerald-100 text-emerald-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">Why CarbonDesk</span>
                <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 leading-tight">
                  Built for enterprise sustainability
                </h2>
              </div>
              
              <div className="grid sm:grid-cols-2 gap-6 sm:gap-8">
                <div className="p-8 sm:p-10 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl border border-emerald-100">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-emerald-600 rounded-2xl flex items-center justify-center mb-6">
                ...
                <div className="p-8 sm:p-10 bg-gradient-to-br from-teal-50 to-emerald-50 rounded-3xl border border-teal-100">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-teal-600 rounded-2xl flex items-center justify-center mb-6">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            {/* Results */}
            <section id="results" className="py-12 sm:py-24">
              <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
                <span className="inline-block px-4 py-1.5 bg-emerald-100 text-emerald-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">Results You Can Expect</span>
                <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 leading-tight">
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                {sustain360Results.map((result, index) => (
                  <div key={index} className="p-5 sm:p-6 bg-emerald-50 rounded-2xl flex items-start gap-4 border border-emerald-100">
                    ...
                    <p className="text-slate-700 text-base sm:text-lg pt-1.5">{result}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            {/* CTA Section */}
            <section className="py-16 sm:py-24 bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900 -mx-4 sm:-mx-6 lg:-mx-12 px-4 sm:px-6 lg:px-12">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6">
                  Ready to transform your carbon management?
                </h2>
                <p className="text-xl sm:text-2xl text-emerald-200 mb-8 sm:mb-10">
                  Start your journey to Net Zero with CarbonDesk.
                </p>
                <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
                  <button
                    onClick={() => setCurrentPage('contact')}
                    className="px-8 sm:px-10 py-3 sm:py-4 bg-white text-emerald-900 rounded-full font-semibold hover:shadow-xl hover:shadow-white/20 transition-all duration-300 text-base sm:text-lg"
                  >
                    Get Started Today
                  </button>
                    <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-8 sm:px-10 py-3 sm:py-4 border-2 border-white/30 text-white rounded-full font-semibold hover:bg-white/10 transition-all duration-300 text-base sm:text-lg"
                  >
                    Try Demo
                  </a>
                </div>
...
// ArborTag Product Detail Page - CORRECTED
const ArborTagPage = () => {
  const { setCurrentPage } = useApp();
  ...
  return (
    <main>
      ...
      <section className="relative min-h-[60vh] sm:min-h-[70vh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 pb-16 sm:pb-24 text-center w-full">
          <div className="w-50 h-50 sm:w-50 sm:h-50 flex items-center justify-center mx-auto mb-6 sm:mb-10">
            <img 
          ...
          <p className="text-xl sm:text-2xl lg:text-3xl text-white/100 mb-8 sm:mb-10 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
            ...
            >
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-teal-900 rounded-full font-semibold hover:shadow-xl hover:shadow-white/20 transition-all duration-300 text-base sm:text-lg"
            >
              View Demo
            </a>
          </div>
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-r from-teal-600 to-emerald-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xl sm:text-2xl lg:text-3xl font-medium text-white italic">
            "Every tree tells a story. ArborTag lets you hear it."
          </p>
          <p className="mt-3 sm:mt-4 text-lg sm:text-xl text-teal-100">
        ...
        <div className="flex-1">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12">
            ...
            <section id="what-we-do" className="py-12 sm:py-24">
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-16 items-center">
                <div>
                  <span className="inline-block px-4 py-1.5 bg-teal-100 text-teal-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">What we do</span>
                  <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 mb-4 sm:mb-6 leading-tight">
            ...
            <section id="problem" className="py-12 sm:py-24">
              <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
                <span className="inline-block px-4 py-1.5 bg-teal-100 text-teal-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">The Problem We Solve</span>
                <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 mb-4 sm:mb-6 leading-tight">
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                {arbortagProblems.map((problem, index) => (
                  <div key={index} className="p-6 sm:p-8 bg-white rounded-2xl border border-slate-200 hover:border-teal-200 hover:shadow-lg hover:shadow-teal-100/50 transition-all duration-300">
            ...
            <section id="solution" className="py-12 sm:py-24">
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-16 items-center">
                ...
                <div className="order-1 lg:order-2">
                  <span className="inline-block px-4 py-1.5 bg-teal-100 text-teal-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">Our Solution</span>
                  <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 mb-4 sm:mb-6 leading-tight">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-start gap-3">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 bg-teal-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                          <CheckIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white" />
                        </div>
                        <span className="text-slate-600 text-sm sm:text-base">{item}</span>
                      </div>
            ...
            <section id="features" className="py-12 sm:py-24">
              <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
                <span className="inline-block px-4 py-1.5 bg-teal-100 text-teal-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">Key Features</span>
                <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 leading-tight">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {arbortagFeatures.map((feature, index) => (
                  <div key={index} className="p-6 sm:p-8 bg-white rounded-2xl border border-slate-200 hover:border-teal-200 hover:shadow-lg transition-all duration-300">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-teal-500 to-emerald-500 rounded-xl flex items-center justify-center mb-4 sm:mb-6">
            ...
            <section className="py-12 sm:py-24">
              <div className="bg-gradient-to-br from-teal-50 to-emerald-50 rounded-3xl p-8 sm:p-10 lg:p-16 border border-teal-100">
                <div className="max-w-3xl">
                  <span className="inline-block px-4 py-1.5 bg-teal-600 text-white rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">Cutting-edge Advantages</span>
                  <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-slate-900 mb-8 sm:mb-10">
                  ...
                  <div className="space-y-4 sm:space-y-5">
                    {arbortagAdvantages.map((advantage, index) => (
                      <div key={index} className="flex items-start gap-3 sm:gap-4">
                        <div className="w-7 h-7 sm:w-8 sm:h-8 bg-teal-600 rounded-full flex items-center justify-center flex-shrink-0">
                          <CheckIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white" />
                        </div>
                        <p className="text-slate-700 text-base sm:text-lg pt-0.5">{advantage}</p>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            {/* Use Cases */}
            <section id="use-cases" className="py-12 sm:py-24">
              <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
                <span className="inline-block px-4 py-1.5 bg-teal-100 text-teal-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">Use Cases</span>
                <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 leading-tight">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                {arbortagUseCases.map((useCase, index) => (
                  <div key={index} className="p-5 sm:p-6 bg-white rounded-2xl border border-slate-200 text-center hover:border-teal-300 hover:bg-teal-50 transition-all duration-300">
                    <p className="text-slate-800 font-medium text-sm sm:text-base">{useCase}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section id="results" className="py-12 sm:py-24">
              <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
                <span className="inline-block px-4 py-1.5 bg-teal-100 text-teal-700 rounded-full text-base sm:text-lg font-medium mb-4 sm:mb-6">Results You Can Expect</span>
                <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 mb-4 sm:mb-6 leading-tight">
              ...
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                {arbortagResults.map((result, index) => (
                  <div key={index} className="p-5 sm:p-6 bg-teal-50 rounded-2xl flex items-start gap-4 border border-teal-100">
            ...
            {/* CTA Section */}
            <section className="py-16 sm:py-24 bg-gradient-to-br from-teal-900 via-emerald-800 to-emerald-900 -mx-4 sm:-mx-6 lg:-mx-12 px-4 sm:px-6 lg:px-12">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6">
                  Ready to tag the future of sustainability?
                </h2>
                <p className="text-lg sm:text-xl text-teal-200 mb-8 sm:mb-10">
                  Get your quote today and transform how you monitor your green assets.
                </p>
                <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
                  <button
                    onClick={() => setCurrentPage('contact')}
                    className="px-8 sm:px-10 py-3 sm:py-4 bg-white text-teal-900 rounded-full font-semibold hover:shadow-xl hover:shadow-white/20 transition-all duration-300 text-base sm:text-lg"
                  >
                    Contact Us
                  </button>
                    <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
            ...
            <div>
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-slate-600 mb-6 sm:mb-8">
                  ...
                  {faqData.map((faq, index) => (
                    <div key={index} className="border border-slate-200 rounded-2xl overflow-hidden">
                      ...
                      >
                        ...
                        <ChevronDownIcon className={`w-5 h-5 text-slate-400 transition-transform flex-shrink-0 ${openFaq === index ? 'rotate-180' : ''}`} />
                      </button>
                      {openFaq === index && (
    ...
    <main className="pt-16 sm:pt-20">
      <section className="py-16 sm:py-24 bg-gradient-to-br from-emerald-50 to-teal-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold text-emerald-900 mb-4 sm:mb-6">
            Privacy Policy
          </h1>
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-sm sm:prose-base lg:prose-lg prose-emerald max-w-none">
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-xl font-bold text-emerald-900 mb-3 sm:mb-4">Summary of Key Points</h3>
              <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base"><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use.</p>
              <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base"><strong>Do we process any sensitive personal information?</strong> Some of the information may be considered "special" or "sensitive" in certain jurisdictions. We may process sensitive personal information when necessary with your consent or as otherwise permitted by applicable law.</p>
              <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base"><strong>Do we collect any information from third parties?</strong> We may collect information from public databases, marketing partners, social media platforms, and other outside sources.</p>
              <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base"><strong>How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law.</p>
              <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base"><strong>How do we keep your information safe?</strong> We have adequate organizational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure.</p>
              <p className="text-slate-600 text-sm sm:text-base"><strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information.</p>
            </div>

            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">1. What Information Do We Collect?</h2>
            <h3 className="text-lg sm:text-xl font-semibold text-emerald-800 mb-2 sm:mb-3">Personal information you disclose to us</h3>
            ...
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base"><strong>Personal Information Provided by You.</strong> The personal information we collect may include:</p>
            <ul className="text-slate-600 mb-4 sm:mb-6 space-y-1 text-sm sm:text-base list-disc pl-5 sm:pl-6">
              <li>Names</li>
              <li>Phone numbers</li>
            ...
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base"><strong>Sensitive Information.</strong> When necessary, with your consent or as otherwise permitted by applicable law, we process the following categories of sensitive information:</p>
            <ul className="text-slate-600 mb-4 sm:mb-6 space-y-1 text-sm sm:text-base list-disc pl-5 sm:pl-6">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-emerald-800 mb-2 sm:mb-3">Information collected from other sources</h3>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">2. How Do We Process Your Information?</h2>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">We process your personal information for a variety of reasons, including:</p>
            <ul className="text-slate-600 mb-6 sm:mb-8 space-y-2 text-sm sm:text-base list-disc pl-5 sm:pl-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">3. What Legal Bases Do We Rely On To Process Your Information?</h2>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">The General Data Protection Regulation (GDPR) and UK GDPR require us to explain the valid legal bases we rely on in order to process your personal information. We may rely on the following legal bases:</p>
            <ul className="text-slate-600 mb-6 sm:mb-8 space-y-2 text-sm sm:text-base list-disc pl-5 sm:pl-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">4. When And With Whom Do We Share Your Personal Information?</h2>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">We may need to share your personal information in the following situations:</p>
            <ul className="text-slate-600 mb-6 sm:mb-8 space-y-2 text-sm sm:text-base list-disc pl-5 sm:pl-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">5. Do We Use Cookies And Other Tracking Technologies?</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">6. Do We Offer Artificial Intelligence-Based Products?</h2>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base"><strong>Use of AI Technologies:</strong> We provide the AI Products through third-party service providers ("AI Service Providers"), including OpenAI, DeepSeek and Perplexity. Your input, output, and personal information will be shared with and processed by these AI Service Providers to enable your use of our AI Products.</p>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base"><strong>Our AI Products are designed for:</strong> AI automation. All personal information processed using our AI Products is handled in line with our Privacy Notice and our agreement with third parties. This ensures high security and safeguards your personal information throughout the process.</p>

            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">7. How Long Do We Keep Your Information?</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">8. How Do We Keep Your Information Safe?</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">9. Do We Collect Information From Minors?</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">10. What Are Your Privacy Rights?</h2>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">In some regions (like the EEA, UK, and Switzerland), you have certain rights under applicable data protection laws. These may include the right:</p>
            <ul className="text-slate-600 mb-4 sm:mb-6 space-y-1 text-sm sm:text-base list-disc pl-5 sm:pl-6">
            ...
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">In certain circumstances, you may also have the right to object to the processing of your personal information.</p>
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">11. Controls For Do-Not-Track Features</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">12. Do We Make Updates To This Notice?</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">13. How Can You Contact Us About This Notice?</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">14. How Can You Review, Update, Or Delete The Data We Collect From You?</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
...
// Terms of Service Page - COMPLETE VERSION
const TermsPage = () => {
  return (
    <main className="pt-16 sm:pt-20">
      <section className="py-16 sm:py-24 bg-gradient-to-br from-emerald-50 to-teal-50">
      ...
      <section className="py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-sm sm:prose-base lg:prose-lg prose-emerald max-w-none">
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4">Agreement To Our Legal Terms</h2>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <p className="text-slate-600 mb-3 sm:mb-4 font-semibold text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">1. Our Services</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">2. Intellectual Property Rights</h2>
            <h3 className="text-lg sm:text-xl font-semibold text-emerald-800 mb-2 sm:mb-3">Our intellectual property</h3>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-emerald-800 mb-2 sm:mb-3">Your use of our Services</h3>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">3. User Representations</h2>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">By using the Services, you represent and warrant that:</p>
            <ul className="text-slate-600 mb-6 sm:mb-8 space-y-1 text-sm sm:text-base list-disc pl-5 sm:pl-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">4. User Registration</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
              You may be required to register to use the Services. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.
            </p>

            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">5. Purchases and Payment</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">6. Subscriptions</h2>
            <h3 className="text-lg sm:text-xl font-semibold text-emerald-800 mb-2 sm:mb-3">Billing and Renewal</h3>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-emerald-800 mb-2 sm:mb-3">Cancellation</h3>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-emerald-800 mb-2 sm:mb-3">Fee Changes</h3>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
              We may, from time to time, make changes to the subscription fee and will communicate any price changes to you in accordance with applicable law.
            </p>

            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">7. Software</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">8. Prohibited Activities</h2>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
              You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.
            </p>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">As a user of the Services, you agree not to:</p>
            <ul className="text-slate-600 mb-6 sm:mb-8 space-y-2 text-sm sm:text-base list-disc pl-5 sm:pl-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">9. User Generated Contributions</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">10. Contribution License</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">11. Guidelines For Reviews</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">12. Services Management</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">13. Privacy Policy</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">14. Term and Termination</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">15. Modifications and Interruptions</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">16. Governing Law</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">17. Dispute Resolution</h2>
            <h3 className="text-lg sm:text-xl font-semibold text-emerald-800 mb-2 sm:mb-3">Informal Negotiations</h3>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-emerald-800 mb-2 sm:mb-3">Binding Arbitration</h3>
            <p className="text-slate-600 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-emerald-800 mb-2 sm:mb-3">Restrictions</h3>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
              The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.
            </p>

            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">18. Corrections</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
              There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.
            </p>

            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">19. Disclaimer</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">20. Limitations of Liability</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
              IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SERVICES, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
            </p>

            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">21. Indemnification</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">22. User Data</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
              We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.
            </p>

            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">23. Electronic Communications, Transactions, and Signatures</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
              Visiting the Services, sending us emails, and completing online forms constitute electronic communications. You consent to receive electronic communications, and you agree that all agreements, notices, disclosures, and other communications we provide to you electronically, via email and on the Services, satisfy any legal requirement that such communication be in writing. YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES, CONTRACTS, ORDERS, AND OTHER RECORDS, AND TO ELECTRONIC DELIVERY OF NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE SERVICES.
            </p>

            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">24. California Users and Residents</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
              If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.
            </p>

            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">25. Miscellaneous</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-emerald-900 mb-3 sm:mb-4 mt-8">26. Contact Us</h2>
            <p className="text-slate-600 mb-6 sm:mb-8 text-sm sm:text-base">
